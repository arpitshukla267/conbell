...
// ---------- Data source ----------
// All product content lives in data/products.ts — this component only
// renders it. Use the same PRODUCTS / getProductById exports on the
// products listing page and the product detail page.
import {
  PRODUCTS,
  type Product,
  type Category,
...
// ---------- Filters ----------
// Matches the Category union in data/products.ts — add a row here whenever
// a new category is added there.
        ...
        <div className="grid grid-cols-1 items-end gap-6 mb-12 lg:grid-cols-[6fr_4fr]">
          ...
          <div ref={headerRef}>
            ...
            <p className="mt-3 max-w-2xl text-[14.5px] font-normal leading-7 text-slate-600 sm:text-[15.5px]">
              <AnimatedReveal
                text="Conveyor structures, mezzanine floors, tanks, platforms, paint booths, and turnkey projects — engineered and fabricated to precise standards."
                inView={headerInView}
                splitBy="word"
                baseDelay={200}
                stepDelay={20}
